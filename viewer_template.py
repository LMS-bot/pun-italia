...
const APP_CASA=[
 ...
 {n:"Lavasciuga",ic:"🌀",kw:2.2,h:3,label:"2.2 kW · ciclo ~3h"},
 {n:"Forno elettrico",ic:"🔥",kw:2.2,h:1,label:"2.2 kW · ciclo ~1h"},
 {n:"Piano cottura a induzione",ic:"🍳",kw:3,h:1,label:"3 kW · uso ~1h/giorno"},
 {n:"Microonde",ic:"📻",kw:1.2,h:0.5,label:"1.2 kW · uso ~0.5h/giorno"},
 {n:"Ferro da stiro",ic:"👔",kw:2.4,h:0.5,label:"2.4 kW · ciclo ~0.5h"},
 {n:"Scaldabagno elettrico",ic:"♨️",kw:1.5,h:2,label:"1.5 kW · uso ~2h/giorno"},
 {n:"Climatizzatore",ic:"❄️",kw:1.2,h:4,label:"1.2 kW · uso ~4h/giorno"},
 {n:"Pompa di calore (riscaldamento)",ic:"🌡️",kw:3,h:6,label:"3 kW · uso ~6h/giorno"},
 {n:"Stufa elettrica",ic:"🔆",kw:2,h:3,label:"2 kW · uso ~3h/giorno"},
...
const BIZ=[
 {id:"ristorante",label:"Ristorante / Bar",icon:"🍽️",equip:[
   ...
   {n:"Piastra / griglia elettrica",ic:"🍳",kw:5,h:3,label:"5 kW · uso ~3h/giorno"},
   {n:"Friggitrice",ic:"🍟",kw:4,h:1,label:"4 kW · uso ~1h/giorno"},
   {n:"Lavastoviglie industriale",ic:"🍽️",kw:6,h:1.5,label:"6 kW · ciclo ~1.5h"},
   {n:"Lavabicchieri bar",ic:"🥂",kw:3,h:2,label:"3 kW · uso ~2h/giorno"},
   {n:"Abbattitore di temperatura",ic:"❄️",kw:3,h:1,label:"3 kW · ciclo ~1h"},
   {n:"Macchina del caffè professionale",ic:"☕",kw:3,h:8,label:"3 kW · uso ~8h/giorno"},
   {n:"Macchina del ghiaccio",ic:"🧊",kw:1.5,h:6,label:"1.5 kW · uso ~6h/giorno"},
   {n:"Cappa di aspirazione",ic:"🌬️",kw:2,h:6,label:"2 kW · uso ~6h/giorno"},
   {n:"Scaldavivande / bagnomaria",ic:"🍲",kw:2,h:4,label:"2 kW · uso ~4h/giorno"},
   {n:"Climatizzazione sala",ic:"❄️",kw:3.5,h:4,label:"3.5 kW · uso ~4h/giorno"},
   {n:"Cella frigo cucina",ic:"🧊",kw:3,continuous:true,label:"3 kW · funzionamento continuo"},
   {n:"Banco bar refrigerato",ic:"🍹",kw:2,continuous:true,label:"2 kW · funzionamento continuo"}]},
 {id:"panificio",label:"Panificio / Pasticceria",icon:"🥖",equip:[
   {n:"Forno industriale",ic:"🔥",kw:15,h:3,label:"15 kW · cottura ~3h/giorno"},
   {n:"Forno rotativo secondario",ic:"🔥",kw:9,h:2,label:"9 kW · uso ~2h/giorno"},
   {n:"Impastatrice a spirale",ic:"🥣",kw:5,h:2,label:"5 kW · uso ~2h/giorno"},
   {n:"Sfogliatrice",ic:"🥐",kw:1.5,h:2,label:"1.5 kW · uso ~2h/giorno"},
   {n:"Spezzatrice / formatrice",ic:"⚙️",kw:2,h:2,label:"2 kW · uso ~2h/giorno"},
   {n:"Cella di lievitazione",ic:"🌡️",kw:2,h:6,label:"2 kW · uso ~6h/giorno"},
   {n:"Abbattitore",ic:"❄️",kw:3,h:1,label:"3 kW · ciclo ~1h"},
   {n:"Lavastoviglie / lavateglie",ic:"🍽️",kw:4,h:1.5,label:"4 kW · ciclo ~1.5h"},
   {n:"Macchina del caffè",ic:"☕",kw:3,h:6,label:"3 kW · uso ~6h/giorno"},
   {n:"Cappa e aspirazione",ic:"🌬️",kw:2,h:6,label:"2 kW · uso ~6h/giorno"},
   {n:"Cella frigo impasti",ic:"🧊",kw:4,continuous:true,label:"4 kW · funzionamento continuo"},
   {n:"Vetrina refrigerata pasticceria",ic:"🍰",kw:2,continuous:true,label:"2 kW · funzionamento continuo"}]},
 {id:"officina",label:"Officina meccanica",icon:"🔧",equip:[
   {n:"Compressore aria",ic:"💨",kw:5.5,h:3,label:"5.5 kW · uso ~3h/giorno"},
   {n:"Compressore secondario",ic:"💨",kw:3,h:2,label:"3 kW · uso ~2h/giorno"},
   ...
   {n:"Forno essiccazione vernici",ic:"🔥",kw:12,h:1,label:"12 kW · ciclo ~1h"},
   {n:"Smontagomme ed equilibratrice",ic:"🛞",kw:3,h:2,label:"3 kW · uso ~2h/giorno"},
   {n:"Banco prova / diagnosi",ic:"🖥️",kw:4,h:3,label:"4 kW · uso ~3h/giorno"},
   {n:"Aspirazione fumi di scarico",ic:"🌬️",kw:3,h:4,label:"3 kW · uso ~4h/giorno"},
   {n:"Idropulitrice",ic:"💦",kw:5,h:1,label:"5 kW · uso ~1h/giorno"},
   {n:"Illuminazione officina",ic:"💡",kw:3,h:9,label:"3 kW · uso ~9h/giorno"},
   {n:"Caricabatterie industriali",ic:"🔌",energy:10,label:"10 kWh ricarica"}]},
 {id:"negozio",label:"Negozio / Retail",icon:"🛍️",equip:[
   ...
   {n:"Insegna luminosa",ic:"🔆",kw:1,h:8,label:"1 kW · uso ~8h/giorno"},
   {n:"Vetrina refrigerata",ic:"🧊",kw:1.5,h:10,label:"1.5 kW · uso ~10h/giorno"},
   {n:"Casse e sistemi IT",ic:"🖥️",kw:1.5,h:10,label:"1.5 kW · uso ~10h/giorno"},
   {n:"Ventilazione e ricambio aria",ic:"🌬️",kw:2,h:8,label:"2 kW · uso ~8h/giorno"},
   {n:"Antitaccheggio",ic:"🛡️",kw:0.5,h:10,label:"0.5 kW · uso ~10h/giorno"},
   {n:"Scaldabagno",ic:"♨️",kw:1.5,h:2,label:"1.5 kW · uso ~2h/giorno"},
   {n:"Cella frigo magazzino",ic:"🧊",kw:2,continuous:true,label:"2 kW · funzionamento continuo"}]},
 {id:"ufficio",label:"Ufficio",icon:"🏢",equip:[
   {n:"Climatizzazione uffici",ic:"❄️",kw:5,h:8,label:"5 kW · uso ~8h/giorno"},
   {n:"Illuminazione uffici",ic:"💡",kw:3,h:9,label:"3 kW · uso ~9h/giorno"},
   {n:"Postazioni e monitor",ic:"💻",kw:2.5,h:8,label:"2.5 kW · uso ~8h/giorno"},
   {n:"Stampanti e multifunzione",ic:"🖨️",kw:1.5,h:6,label:"1.5 kW · uso ~6h/giorno"},
   {n:"Distributori e macchina caffè",ic:"☕",kw:1.5,h:8,label:"1.5 kW · uso ~8h/giorno"},
   {n:"Ventilazione meccanica",ic:"🌬️",kw:2,h:9,label:"2 kW · uso ~9h/giorno"},
   {n:"Sala server",ic:"🖥️",kw:3,continuous:true,label:"3 kW · funzionamento continuo"},
   {n:"Gruppo di continuità (UPS)",ic:"🔋",kw:1,continuous:true,label:"1 kW · funzionamento continuo"},
 ...
 {id:"lavanderia",label:"Lavanderia industriale",icon:"🧺",equip:[
   ...
   {n:"Lavacontinua",ic:"💦",kw:15,h:6,label:"15 kW · uso ~6h/giorno"},
   {n:"Asciugatrice industriale",ic:"🌬️",kw:12,h:1,label:"12 kW · ciclo ~1h"},
   {n:"Essiccatoio",ic:"♨️",kw:10,h:3,label:"10 kW · uso ~3h/giorno"},
   {n:"Stiratrice a vapore",ic:"♨️",kw:7,h:2,label:"7 kW · uso ~2h/giorno"},
   {n:"Mangano / calandra",ic:"🧻",kw:8,h:3,label:"8 kW · uso ~3h/giorno"},
   {n:"Generatore di vapore elettrico",ic:"🔥",kw:12,h:4,label:"12 kW · uso ~4h/giorno"},
   {n:"Compressore",ic:"💨",kw:4,h:4,label:"4 kW · uso ~4h/giorno"},
   {n:"Aspirazione e ventilazione",ic:"🌬️",kw:3,h:8,label:"3 kW · uso ~8h/giorno"}]},
 {id:"hotel",label:"Hotel / Agriturismo",icon:"🏨",equip:[
   {n:"Cucina industriale",ic:"🍳",kw:10,h:3,label:"10 kW · uso ~3h/giorno"},
   {n:"Lavastoviglie industriale",ic:"🍽️",kw:6,h:2,label:"6 kW · uso ~2h/giorno"},
   {n:"Lavatrici biancheria",ic:"💦",kw:6,h:1.5,label:"6 kW · ciclo ~1.5h"},
   {n:"Asciugatrice biancheria",ic:"🌬️",kw:8,h:2,label:"8 kW · uso ~2h/giorno"},
   {n:"Pompa di calore ACS",ic:"♨️",kw:8,h:6,label:"8 kW · uso ~6h/giorno"},
   {n:"Climatizzazione camere",ic:"❄️",kw:6,h:8,label:"6 kW · uso ~8h/giorno"},
   {n:"Illuminazione aree comuni",ic:"💡",kw:4,h:10,label:"4 kW · uso ~10h/giorno"},
   {n:"Pompa filtraggio piscina",ic:"🏊",kw:2,h:6,label:"2 kW · uso ~6h/giorno"},
   {n:"Sauna / area benessere",ic:"🔥",kw:6,h:3,label:"6 kW · uso ~3h/giorno"},
   {n:"Ascensori",ic:"🛗",kw:5,h:6,label:"5 kW · uso ~6h/giorno"},
   {n:"Frigoriferi e celle cucina",ic:"🧊",kw:4,continuous:true,label:"4 kW · funzionamento continuo"},
   {n:"Ricarica auto ospiti",ic:"🚗",energy:22,label:"22 kWh ricarica"}]},
 {id:"palestra",label:"Palestra / Centro estetico",icon:"💪",equip:[
   ...
   {n:"Ventilazione e ricambio aria",ic:"🌬️",kw:3,h:10,label:"3 kW · uso ~10h/giorno"},
   {n:"Attrezzi cardio (tapis, ellittiche)",ic:"🏃",kw:5,h:8,label:"5 kW · uso ~8h/giorno"},
   {n:"Illuminazione sale",ic:"💡",kw:4,h:10,label:"4 kW · uso ~10h/giorno"},
   {n:"Boiler docce",ic:"♨️",kw:6,h:4,label:"6 kW · uso ~4h/giorno"},
   {n:"Lettini abbronzanti",ic:"🔆",kw:5,h:3,label:"5 kW · uso ~3h/giorno"},
   {n:"Pompa idromassaggio / piscina",ic:"🏊",kw:4,h:6,label:"4 kW · uso ~6h/giorno"},
 ...
 {id:"supermercato",label:"Supermercato",icon:"🛒",equip:[
   ...
   {n:"Cella frigo carni e latticini",ic:"🥩",kw:6,continuous:true,label:"6 kW · funzionamento continuo"},
   {n:"Banco pesce e produzione ghiaccio",ic:"🐟",kw:3,continuous:true,label:"3 kW · funzionamento continuo"},
   ...
   {n:"Forno gastronomia / rosticceria",ic:"🔥",kw:10,h:4,label:"10 kW · uso ~4h/giorno"},
   {n:"Forno panetteria interna",ic:"🥖",kw:12,h:3,label:"12 kW · cottura ~3h/giorno"},
   {n:"Abbattitore di temperatura",ic:"🌡️",kw:5,h:1,label:"5 kW · ciclo ~1h"},
   {n:"Affettatrici e banco salumeria",ic:"🔪",kw:1.5,h:6,label:"1.5 kW · uso ~6h/giorno"},
   {n:"Impianto aspirazione e ventilazione",ic:"🌬️",kw:4,h:12,label:"4 kW · uso ~12h/giorno"},
   {n:"Compattatore / pressa cartone",ic:"♻️",kw:5,h:1,label:"5 kW · uso ~1h/giorno"},
   {n:"Casse, server e sistemi IT",ic:"🖥️",kw:2,h:12,label:"2 kW · uso ~12h/giorno"},
   {n:"Lavapavimenti industriale (ricarica)",ic:"🧽",energy:6,label:"6 kWh ricarica"},
 ...
 {id:"manifattura",label:"Azienda manifatturiera",icon:"🏭",equip:[
   ...
   {n:"Presse",ic:"🛠️",kw:20,h:6,label:"20 kW · uso ~6h/giorno"},
   ...
   {n:"Forno di essiccazione",ic:"♨️",kw:15,h:4,label:"15 kW · uso ~4h/giorno"},
   {n:"Saldatura robotizzata",ic:"⚡",kw:12,h:5,label:"12 kW · uso ~5h/giorno"},
   {n:"Pompe idrauliche",ic:"🔧",kw:8,h:8,label:"8 kW · uso ~8h/giorno"},
   {n:"Impianto aspirazione/ventilazione",ic:"🌬️",kw:8,h:8,label:"8 kW · uso ~8h/giorno"},
   {n:"Illuminazione capannone",ic:"💡",kw:6,h:10,label:"6 kW · uso ~10h/giorno"},
   {n:"Trattamento acque di processo",ic:"💧",kw:4,h:8,label:"4 kW · uso ~8h/giorno"},
   {n:"Chiller raffreddamento processo",ic:"🧊",kw:10,continuous:true,label:"10 kW · funzionamento continuo"},
   {n:"Ricarica mezzi e muletti",ic:"🚚",energy:30,label:"30 kWh ricarica"}]}
];
